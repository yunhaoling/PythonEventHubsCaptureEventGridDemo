...
#----------------------------------------------------------------------------------------------
# NOTE:
# 1. bulk insert syntax of T-SQL isn't supported in sql server 2012
...
def batch_insert(data_list):
    ...
    db_connection = pyodbc.connect(db_connection_str, autocommit=False)
